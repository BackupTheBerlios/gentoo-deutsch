...
<!--			<td width="99%" valign="bottom" bgcolor="#000000">
				...
				<tr>
					<td valign="top">
						...
						&#160;<a class="oldlink" href="/index-projects.html">Projekte</a><br/> 
						<br/>
					</td>
				</tr>
				<tr>
...
<!--content end-->
			...
			<td width="1%" bgcolor="#dddaec" valign="top">
				...
				<td align="center" class="alttext">
						letzte &#196;nderung <xsl:value-of select="/guide/date"/>
				</td>
				</tr>
				<tr>
				<td>
				...
				<tr>
					<td class="alttext">
						<b>Zusammenfassung:</b>&#160;<xsl:apply-templates select="abstract"/>
					</td>
				</tr> <!--
				<tr>
				<td>
...
<!--Netscape 4.7 hack end-->
		...
		<tr>
			...
			Fragen, Kommentare, Korretkuren?  Email <a class="highlight"
		href="mailto:gentoo-deutsch-dev@lists.berlios.de">gentoo-deutsch-dev@lists.berlios.de</a>.
			</td>
		</tr> 
	</table>
</body>
...
<xsl:template match="figure">
	...
	<p class="caption">
		<xsl:choose>
			<xsl:when test="@caption">
				Abbildung <xsl:value-of select="$fignum"/>: <xsl:value-of select="@caption" />
			</xsl:when>
			<xsl:otherwise>
				Abbildung <xsl:value-of select="$fignum"/>
			</xsl:otherwise>
		</xsl:choose>
	</p>
	</td></tr>
	...
	<xsl:choose>
		<xsl:when test="@short">
			<img src="{@link}" alt="Abb. {$fignum}: {@short}"/>
		</xsl:when>
		<xsl:otherwise>
			<img src="{@link}" alt="Abb. {$fignum}"/>
		</xsl:otherwise>
	</xsl:choose>
	</td></tr></table>
	<br/>
...
<xsl:template match="pre">
	...
	<xsl:choose>
		<xsl:when test="@caption">
			Beispiel <xsl:value-of select="$prenum"/>: <xsl:value-of select="@caption" />
		</xsl:when>
		<xsl:otherwise>
			Beispiel <xsl:value-of select="$prenum"/>
		</xsl:otherwise>
	</xsl:choose>
	</p>
	</td></tr>
