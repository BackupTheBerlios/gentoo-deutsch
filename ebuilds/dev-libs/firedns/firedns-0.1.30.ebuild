...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/dev-libs/firedns/firedns-0.1.30.ebuild,v 1.1 2003/03/21 17:50:34 holler Exp $


S=${WORKDIR}/${PN}

DESCRIPTION="FireDNS Library - libfiredns is a library for handling asynchronous DNS
requests."
