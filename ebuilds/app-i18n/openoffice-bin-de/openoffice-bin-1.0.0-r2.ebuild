...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/app-i18n/openoffice-bin-de/Attic/openoffice-bin-1.0.0-r2.ebuild,v 1.1 2002/07/10 10:54:25 jay Exp $
...
OO_SRC=OOo_${MY_PV}_LinuxIntel_install.tar.gz
SRC_URI="
	http://ny1.mirror.openoffice.org/${PV}/${OO_SRC}
        ftp://ftp.gwdg.de/pub/misc/openoffice/contrib/deutsch/1.0.0/OOo_1.0.0_LinuxIntel_install_de.tar.gz
...
# german 
if test $(locale | grep -i LC_ALL | grep -i 'de_'); then
    OO_LANG="de_"
    OO_SRC_WB="de_DE.zip"
...
# french 
if test $(locale | grep -i LC_ALL | grep -i 'fr_'); then
    echo "***************************************"
    echo "Using french version - disable. Missing binary."
    echo "***************************************"
#    OO_SRC=OOo_${MY_PV}_LinuxIntel_install_de.tar.gz
#    SRC_URI="
#        ftp://ftp.gwdg.de/pub/misc/openoffice/contrib/deutsch/${PV}/${OO_SRC}
