...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/media-tv/linuxtv-dvb/linuxtv-dvb-1.1.1-r2.ebuild,v 1.1 2004/07/27 19:32:40 austriancoder Exp $
...
src_unpack() {
	...
	# to support the yaepg-plugin
	epatch ${FILESDIR}/yaepg-plugin.diff
}
