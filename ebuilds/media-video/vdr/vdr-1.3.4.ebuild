...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/media-video/vdr/vdr-1.3.4.ebuild,v 1.1 2004/02/15 13:23:36 mad Exp $
...
SRC_URI="
		...
		http://linvdr.org/download/VDR-AIO/vdr-1.3.4-ElchiAIO4b.diff.gz
		"
...
src_unpack() {
	...
	then
		...
		then
			...
			cd ${S}
			epatch ../vdr-1.3.4-ElchiAIO4b.diff
			#if vdr_opts iosd
			#then
