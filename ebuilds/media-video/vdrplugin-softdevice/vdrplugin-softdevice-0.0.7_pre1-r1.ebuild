...
SRC_URI="http://www.lucke.in-berlin.de/old_stuff/vdr-softdevice-0.0.7pre1.tar.bz2"
KEYWORDS="~x86"
SLOT="0"
LICENSE="GPL"
...
src_unpack() {
    ...
    sed -i "s/^VIDIX_DIR.*$/VIDIX_DIR = \/usr/" ${S}/Makefile
	...
	# wird benötigt, wenn nur vidix support aktiviert ist
