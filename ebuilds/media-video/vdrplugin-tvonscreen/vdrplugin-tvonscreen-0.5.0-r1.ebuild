...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/media-video/vdrplugin-tvonscreen/Attic/vdrplugin-tvonscreen-0.5.0-r1.ebuild,v 1.1 2004/03/23 16:09:27 fow0ryl Exp $
...
src_unpack() {
	...
	# patch works with vdr 1.2.x and 1.3.x
	epatch ${WORKDIR}/vdr-136-tvonscreen-0.5.0-patch.diff
}
