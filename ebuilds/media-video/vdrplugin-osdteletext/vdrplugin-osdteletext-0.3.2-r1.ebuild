...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/media-video/vdrplugin-osdteletext/vdrplugin-osdteletext-0.3.2-r1.ebuild,v 1.1 2004/06/02 12:39:36 austriancoder Exp ${VDRPLUGIN}/vdr-${VDRPLUGIN}-0.3.1.ebuild,v 1.1 2003/05/13 09:39:19 fow0ryl Exp $
...
src_unpack() {
	...
	then
	epatch ${FILESDIR}/osdteletext-${PV}-1.3.7.diff
	fi
}
