...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/sys-apps/pcmcia-cs/Attic/pcmcia-cs-3.2.5-r1.ebuild,v 1.1 2003/10/12 20:14:53 longint Exp $
...
SRC_URI="mirror://sourceforge/pcmcia-cs/${P}.tar.gz
		...
		http://pcmcia-cs.sourceforge.net/ftp/contrib/teles_cs_3.2.5_2.4.22.diff.bz2"
...
src_unpack() {
	...
	then
		...
		#includes Support for Teles ISDN PCMCIA-Card (not usable for kernel-2.6)
		epatch ${DISTDIR}/teles_cs_3.2.5_2.4.22.diff.bz2
	fi
