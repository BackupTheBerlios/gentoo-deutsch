#!/bin/sh
## $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/net-mail/cyrus-imapd/files/gentestcrt.sh,v 1.1 2002/10/08 11:09:00 holler Exp $
##
