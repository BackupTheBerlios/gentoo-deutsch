...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/ebuilds/ebuilds/dev-python/omniORBpy/Attic/omniORBpy-2.1.ebuild,v 1.1 2003/08/22 15:27:33 fow0ryl Exp $
...
KEYWORDS="~x86"
IUSE=""
RDEPEND="=net-misc/omniORB-4.0.1" 
DEPEND="${RDEPEND}"
S="${WORKDIR}/${P}"
