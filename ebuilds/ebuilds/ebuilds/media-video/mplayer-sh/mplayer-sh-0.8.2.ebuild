...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/ebuilds/ebuilds/media-video/mplayer-sh/Attic/mplayer-sh-0.8.2.ebuild,v 1.1 2003/08/22 15:27:35 fow0ryl Exp $

IUSE=""

S=${WORKDIR}/mplayer-sh-0.8.2
DESCRIPTION="Video Disk Recorder Mplayer Script"
HOMEPAGE="http://batleth.sapienti-sat.org/"
SRC_URI="http://batleth.sapienti-sat.org/projects/VDR/mplayer.sh-0.8.2.tar.gz"
KEYWORDS="x86"
SLOT="0"
LICENSE="GPL-2"
