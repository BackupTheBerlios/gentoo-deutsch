...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/sys-kernel/love-sources/love-sources-2.6.8_rc2-r1.ebuild,v 1.1 2004/07/19 21:56:46 austriancoder Exp $

# Only set MMV to numeric value of -mm release
# Version of Andrew Morton's patchset
#MMV="1" we hate mm this release
RESTRICT="nomirror"
LOVEM="neenee" # love maintainer
...
case "$LOVEM" in
	'neenee')
	LOVEPV_SRC="http://cos.evilforums.com/bin/${KV}.bz2"
...
K_EXTRAEWARN="IMPORTANT: The Love-Sources Community remind you that the patches
