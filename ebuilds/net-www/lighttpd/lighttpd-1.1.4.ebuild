...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/net-www/lighttpd/lighttpd-1.1.4.ebuild,v 1.1 2004/04/05 09:53:50 sirro Exp $
...
src_compile() {
	epatch ${FILESDIR}/lighttpd-1.1.4-gentoo.diff
	if [ `use ssl` ]; then
