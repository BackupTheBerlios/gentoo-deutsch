...
# $Header: /home/xubuntu/berlios_backup/github/tmp-cvs/gentoo-deutsch/Repository/ebuilds/x11-libs/gtk+/Attic/gtk+-2.2.2-r2.ebuild,v 1.1 2003/06/13 15:16:11 elefantenfloh Exp $
...
# Patch doesn't work with 2.2.2
#	epatch ${FILESDIR}/gtk-enhanced-20030315.patch 


	# Add menu shadow
	epatch ${FILESDIR}/gtkmenu-shadow.patch 
